...
- Description: The goal is to understand downsizing (aka. layoffs) trends in the USA.
- Task: Help me clean a downsizing announcement dataset, then visualize information and find interesting trends.
- Skills: Data cleaning, visualization, and analysis. Communicating your findings.
- Softwares: MS Excel or Google Sheets. Possibly other visualization apps (e.g., PowerBI, Tableau, etc.)
